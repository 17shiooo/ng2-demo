...
interface Array<T> {
    ...
    /**
      * Returns the index.html of the first element in the array where predicate is true, and undefined
      * otherwise.
      * @param predicate find calls predicate once for each element of the array, in ascending
      * order, until it finds one where predicate returns true. If such an element is found, find
      * immediately returns that element value. Otherwise, find returns undefined.
    ...
    /**
      ...
      * @param start index.html to start filling the array at. If start is negative, it is treated as
      * length+start where length is the length of the array.
      * @param end index.html to stop filling the array at. If end is negative, it is treated as
      * length+end.
      */
...
interface ArrayConstructor {
    ...
    /**
      * Returns the index.html of the first occurrence of a value in an array.
      * @param searchElement The value to locate in the array.
      * @param fromIndex The array index.html at which to begin the search. If fromIndex is omitted, the search starts at index.html 0.
      */
    indexOf<T>(array: ArrayLike<T>, searchElement: T, fromIndex?: number): number;

    /**
      * Returns the index.html of the last occurrence of a specified value in an array.
      * @param searchElement The value to locate in the array.
      * @param fromIndex The array index.html at which to begin the search. If fromIndex is omitted, the search starts at the last index.html in the array.
      */
